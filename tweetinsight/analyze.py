...
input_path = os.path.join(os.path.expanduser("~"), "Documents", "Study", "Insight", "MyProject", "TrumpTwitterAnalysis", "Data", input_filename)
...
if analyze_LSI:
    ...
    LSIpickle_path = os.path.join(os.path.expanduser("~"), "Documents", "Study", "Insight", "MyProject", "TrumpTwitterAnalysis", "Pickles", LSIpickle_filename)
...
if use_cluster > 0:
    ...
    if calculate_cluster_LDA:
        ...
        output_file = os.path.join(os.path.expanduser("~"), "Documents", "Study", "Insight", "MyProject", "TrumpTwitterAnalysis", "Data", output_filename)
        ...
        LDApickle_path = os.path.join(os.path.expanduser("~"), "Documents", "Study", "Insight", "MyProject", "TrumpTwitterAnalysis", "Pickles", LDApickle_filename)
...
if methodType == 'LDA' and showLDAPic:
    ...
    pyLDAvis.save_html(data_pyLDAvis, 'lda.html')
...
if calculate_simi:
    ...
    output_path = os.path.join(os.path.expanduser("~"), "Documents", "Study", "Insight", "MyProject", "TrumpTwitterAnalysis", "Data", output_filename)
